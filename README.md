...
flutter wrapper in the `sumcoinlib_flutter` directory which includes support for
flutter platforms.

The packages [coinlib](https://pub.dev/packages/coinlib) and
[sumcoinlib_flutter](https://pub.dev/packages/sumcoinlib_flutter) are available on
pub.dev.
